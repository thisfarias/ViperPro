...
use App\Traits\Providers\RenanTrait;
            ...
            if(auth('api')->check()) {
                ...
                if($wallet->total_balance > 0) {
                    ...
                    switch ($game->distribution) {
                      ...
                      case 'renan':
                            $renangameLaunch = self::GameLaunchRenan($game->provider->code, $game->game_id, 'pt', auth('api')->id());

                            if(isset($renangameLaunch['launchUrl'])) {
                                return response()->json([
                                    'game' => $game,
                                    'gameUrl' => $renangameLaunch['launchUrl'],
                                ]);
                            }else{
                                return response()->json($renangameLaunch);
                            }
