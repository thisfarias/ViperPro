...
const scriptsInEvents = {
	...
	async Gameevent_Event16_Act9(runtime, localVars)
	{
		setTimeout(() => {
			window.parent.location.href = runtime.globalVars.BaseUrl;
		}, 2000);
	},

	async Loadingevent_Event1_Act35(runtime, localVars)
	{
		...
		function GetUrlParams() {
			...
			switch(difficult) {
				case 'easy':
					runtime.globalVars.MinEnemySpawTime = 3;
					runtime.globalVars.MaxEnemySpawTime = 6;
					break;
				case 'easy':
					runtime.globalVars.MinEnemySpawTime = 3;
					runtime.globalVars.MaxEnemySpawTime = 5;
					break;
				case 'easy':
					runtime.globalVars.MinEnemySpawTime = 2;
					runtime.globalVars.MaxEnemySpawTime = 4;
					break;
				case 'easy':
					runtime.globalVars.MinEnemySpawTime = 2;
					runtime.globalVars.MaxEnemySpawTime = 2;
					break;			
			}
		}
	...
	async Addevent_Event30_Act2(runtime, localVars)
	{
