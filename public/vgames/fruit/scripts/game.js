...
var barbette = function(){
    ...
    var startX = random( 1920 ), endX = random( 1920 ), startY = 600;
...
exports.sliceAt = function( fruit, angle ){
    var index;
    var infos = fruit.infos;
    var values = fruit.fruitValues;
    ...
    if (fruit.type !== "boom") {
        ...
        // Adicionar o valor da fruta cortada à pontuação
        var fruitValue = fruit.value;

        // Adicionar a pontuação de acordo com o valor da fruta
        exports.applyScore(scoreNumber + fruitValue);

        // Atualizar a pontuação
        score.number(scoreNumber + fruitValue);
    } else {
        boomSnd.play();
        this.pauseAllFruit();
        background.wobble();
